...
# ALL DATA IMPORTING, CLEANING, AND FEATURE ENGINEERING #
...
# Final Full Dataset - contains redundant columns to ICJ437 Data Project
...
write.csv(trains_full_data, "data/trains_full_data.csv")



# Final Intro to Data Science project dataset

trains <- trains_full_data %>% dplyr::select(year_commencing, yQ, operator, region, ppm, p_journey_millions, p_km_billions,
                                             trains_planned, yrly_stations_managed, yrly_fte, p_journeys_per_fte, p_km_per_fte, 
                                             trains_planned_per_fte, p_journeys_per_station, p_km_per_station, trains_planned_per_station)

write.csv(trains, "data/trains_df.csv")
